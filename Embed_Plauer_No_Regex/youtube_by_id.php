...
function youtube_embed($url, $width="100%", $height="100%", $fullscreen=true)  /* FULL SCREEN */
{
    ...
    $youtube_embed_body = '<iframe allowtransparency="true" scrolling="no" width="'.$width.'" height="'.$height.'" src="//www.youtube.com/embed/'.$array_variable['v'].'" frameborder="0"'.($fullscreen?' allowfullscreen':NULL).'></iframe>';
    return $youtube_embed_body;
}
